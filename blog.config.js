...
const BLOG = {
  AUTHOR: 'henryswiftstar', // 作者
  BIO: '遊戲開發者', // 作者简介
  LINK: 'https://henrytech.life', // 网站地址
  KEYWORDS: 'Notion, 博客', '部落格' // 网站关键词 英文逗号隔开
  NOTION_PAGE_ID:
    process.env.NOTION_PAGE_ID || '6fd2216b67f141a5911bc6393ac140d1', // Important page_id！！！Duplicate Template from  https://www.notion.so/tanghh/02ab3b8678004aa69e9e415905ef32a5
  ...
  CONTACT_EMAIL: 'h79121@hotmail.com',
  CONTACT_WEIBO: '',
  CONTACT_TWITTER: '',
  CONTACT_GITHUB: 'https://github.com/Swiftstar',
  CONTACT_TELEGRAM: '',
